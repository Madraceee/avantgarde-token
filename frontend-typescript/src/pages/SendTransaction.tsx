...
const Send: FC = ()=>{
    ...
    const accountAddress: string = "123" // useSelector(state=>state.wallet.address);
    useEffect(()=>{
      if(accountAddress===""){
        Router.push("./");
      }
        ...
        <div className='background'>
          ...
          <div className='my-36 grid place-items-center'>
            <div className='flex flex-col w-80 md:w-96'>
              ...
              <button className='mt-5 bg-highlight text-textColor w-44 mx-auto rounded-md' onClick={()=>sendTokens(address,amount.toString())}>Send Tokens</button>
            </div>
          </div>
